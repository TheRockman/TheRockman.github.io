  ...
  $scope.projects = [
    {
      ...
      Tags: ['Blog', 'About'],
      Theme: 'dodgerblue',
      Poster: './img/profilePoster.png',
      PosterSmall: './img/musicPoster.png',
      Backdrop: './img/profileBack.png'
    },
    {
      Title: 'Doodles',
      ...
      Tags: ['Drawing', 'Making'],
      Theme: '#F53C6D',
      Poster: './img/doodlePoster.png',
      PosterSmall: './img/musicPoster.png',
      Backdrop: './img/doodleBack.png',
    ...
    },
    {
      ...
      Tags: ['Music', 'Making'],
      Theme: '#6C4796',
      Poster: './img/musicPoster.png',
      PosterSmall: './img/musicPoster.png',
      Backdrop: './img/musicBack.png',
