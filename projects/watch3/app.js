var app = angular.module("myApp", ['ngTouch']); app.controller("mainCtrl", function($scope) {
  ...
  $scope.debates = [
    {
      ...
      arguments: {
        ...
        BB: {
          ...
          modRejected: -1,
          descRejected: "I hope you know what you are doing.\nWe cant sit idle forever, sooner or later we need to act - perhaps it would have been better to do so while we had a choice?",
        },
        CC: {
          faction: 'CC',
          desc: 'Absolutely unthinkable!\nOur fighters are alreday risking life and limb facing the enemy.\n"Singed eyebrows?" Blasted apart more likely. The last thing they need is for their own weapons to jam or heaven forbid blow them into smithereens.',
          modApproved: -5,
        ...
        DD: {
          faction: 'DD',
          desc: "I have no ship in this race, or rather no knife in this gunfight.\nWhile i´ll be the first to tell you that giving the barrel of monkeys explosive bananas is asking for carnage, maybe thats just kick we need.\nI´ll let you light this fuse entirely on your own mate.",
          modApproved: 0,
  ...
  $scope.currentDebate = $scope.debates[0];
